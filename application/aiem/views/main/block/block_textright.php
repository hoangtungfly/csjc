<div class="row row_<?=$key-1?>">
    <div class="col-xs-6 col col_1 hidden-xxs" style="background: #0079AF url(<?= isset($item['image']) ? $item['image'] : ''?>);background-position: center;background-repeat: no-repeat;background-size: cover;"></div>

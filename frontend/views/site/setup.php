...
<div class="col-md-6 content_wc">
    <p class="p_wellcome">Welcome to Metrixa, Please create your password</p>
    <p class="creat_pass">Create password</p>
    <div class="frm_create_pass">
        ...
        <?= Html::submitButton('Create Password', ['class'=>"btn btn-submit btn-convert next-btn full-button", 'style'=>"width:100%" ])?>

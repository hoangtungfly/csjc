...
$modelTable = common\models\admin\SettingsTableSearch::findOne(90);
$listGrid = SettingsGrid::find()->select('grid_id,label,status')->where(['table_id' => 90])->all();
$displayValue = [];
if($modelTable) {
...
<div class="breadcrumbs" id="breadcrumbs">
    <ul class="breadcrumb">
        ...
        <li><a class="breadcrumbsa" href="<?=$this->createUrl('/product/product/index')?>"><?=Yii::t("admin","Product")?></a></li>        
    </ul>
<?php if (user()->id == 1) { ?>
    <div class="fr">
        <a id="buildgrid_link" href="<?= $this->createUrl('/settings/grid/index', array('SettingsGridSearch[table_id]' => 90)) ?>" class="btn btn-info bnone">Build Grid</a>
        <a id="buildform_link" href="<?= $this->createUrl('/settings/buildform/index', array('table_id' => 90)) ?>" class="btn btn-primary bnone">Build Form</a>
    </div>
<?php } ?>
</div>
<!--END BREADCRUMB-->
...
<div class="page-header">
    <h1 class="fl" style="width:100%;"><span><?=Yii::t('admin','Product')?> (<?=$total?>)</span></h1>
...
echo GridView::widget([
	...
	'class' => 'column_415',
        ...
        [
            ...
            'enableSorting' => false,
            'value' => function ($data)  {
                return '<span class="D_value">' . $data->description . '</span>';
            },
                        'headerOptions' => [
	'class' => 'column_416',
],            'contentOptions' => [

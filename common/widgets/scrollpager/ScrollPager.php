...
namespace common\widgets\scrollpager;

use common\widgets\scrollpager\assets\InfiniteAjaxScrollAsset;
...
class ScrollPager extends Widget
{
    ...
    public function init()
    {
        ...
        Yii::$app->i18n->translations = ArrayHelper::merge(Yii::$app->i18n->translations, [
            'common\widgets\scrollpager' => [
                'class' => PhpMessageSource::className(),
                'basePath' => 'common/widgets/scrollpager/messages',
                'fileMap' => [
                    'common\widgets\scrollpager' => 'general.php'
                ]
            ]
        ]);

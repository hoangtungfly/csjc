...
(function() {
  ...
  Chosen = (function(_super) {
    ...
    Chosen.prototype.set_up_html = function() {
      ...
      if (this.is_multiple) {
        ...
        if(this.create_option){
            placeholder += ' or add new field';
        }
        this.container.html('<a class="chosen-single chosen-default" tabindex="-1"><span>' + this.default_text + '</span><div><i class="fa fa-caret-down"></i><b></b></div></a><div class="chosen-drop"><div class="chosen-search"><input placeholder="'+placeholder+'" type="text" autocomplete="off" onchange="event.preventDefault();event.stopPropagation();return false;" onKeyDown="return disableEnterKey(event)" /></div><ul class="chosen-results"></ul></div>');
      }
    ...
    Chosen.prototype.show_create_option = function(terms) {
      ...
      create_option_html = $('<li class="create-option active-result new_option"><a>' + this.create_option_text + '</a>: "' + terms + '"</li>');
      return this.search_results.prepend(create_option_html);
    };

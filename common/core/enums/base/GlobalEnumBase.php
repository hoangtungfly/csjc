...
namespace common\core\enums\base;

use ReflectionClass;
use Exception;

abstract class GlobalEnumBase {
    ...
    //protected static $enumLabel = array();
    // Caching of values
    public $_allValues;
    public $_dropDownValues;
    protected $enumLabels;
    protected $enumDescriptions;
    ...
    /**
     * get labels of all enums
     * 
     * @return array
     */
    protected function _enumLabels() {
        return $this->enumLabels;
    }

    /**
     * get label of one enum
     * 
     * @param type $enum
     * @return string
     */
    protected function _enumLabel($enum) {
        $label = $this->enumLabels;
        return isset($label[$enum]) ? $label[$enum] : null;
    }
     ...
     * @return array
     */
    protected function _enumDescriptions() {
     ...
     * @return string
     */
    protected function _enumDescription($enum) {
        $des = $this->enumDescriptions;
        return isset($des[$enum]) ? $des[$enum] : null;
    }
}
